...
PICS = (environ.get('PICS', 'https://i.ibb.co/20H4FgFz/photo-2025-12-20-09-39-28-7585872552178745372.jpg https://i.ibb.co/JRh3sgD7/photo-2025-12-20-09-39-28-7585872513524039704.jpg https://i.ibb.co/cKr30dpg/photo-2025-12-20-09-39-10-7585872487754235932.jpg https://i.ibb.co/V5P4nsk/photo-2025-12-20-09-39-27-7585872586538483736.jpg https://i.ibb.co/4RtxKZJS/photo-2025-12-20-09-39-28-7585872612308287516.jpg')).split() 
...
auth_grp = environ.get('AUTH_GROUP', '-1003597376714')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003540411814') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003609815135') 
...
SUPPORT_GRP = environ.get('SUPPORT_GRP', 'https://t.me/Graduate_Request_Pro')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/hshjjjhhhh') 
